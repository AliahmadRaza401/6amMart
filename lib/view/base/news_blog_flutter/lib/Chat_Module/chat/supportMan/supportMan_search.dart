...
class SupportManSearch extends StatefulWidget {
  const SupportManSearch();

  @override
  _SupportManSearchState createState() => _SupportManSearchState();
}

class _SupportManSearchState extends State<SupportManSearch> {
  ...
  Future<ChatRoomModel?> getChatroomModel(MyUserModel targetUser) async {
    ...
    if (snapshot.docs.length > 0) {
      ...
      print("Create NEw Chat Room______________________");
      var uuid = Uuid();
      // Create a new one
                                ...
                                RouteTransitions(
                                  ...
                                  child: ChatRoom(
                                    ...
                                    targetUser: MyUserModel(
                                      ...
                                      twitter: searchedUser.twitter.toString(),
                                      dribble: searchedUser.dribble.toString(),
                                      status: searchedUser.status.toString(),
                                      bio: searchedUser.bio.toString(),
                                      deviceToken:
                                          searchedUser.deviceToken.toString(),
                                    ),
