...
class _CupertinoControlsState extends State<CupertinoControls> {
        ...
        child: ClipRRect(
          ...
          child: BackdropFilter(
            ...
            child: Container(
              ...
              child: Center(
                child: Icon(
                  chewieController!.isFullScreen ? MaterialIcons.close_fullscreen : MaterialIcons.fullscreen,
                  color: iconColor,
                  size: 12.0,
                ),
              ),
  ...
  GestureDetector _buildPlayPause(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Icon(
          controller.value.isPlaying ? MaterialIcons.pause : MaterialIcons.play_arrow,
          color: iconColor,
          size: 16.0,
        ),
      ),
  ...
  Widget _buildRemaining(Color iconColor) {
    final position = _latestValue != null ? _latestValue!.duration - _latestValue!.position : Duration(seconds: 0);
